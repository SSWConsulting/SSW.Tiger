 ...
 * The record is CREATED by the Portal API (portal-api/src/services/submissionStore.js)
 ...
 */
async function updateSubmissionStatus({ requestId, projectName, status, dashboardUrl }) {
