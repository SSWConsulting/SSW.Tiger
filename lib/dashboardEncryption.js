  ...
  <script>
    ...
    async function tryUnlock(password) {
      ...
      try {
        ...
        const key = await deriveKey(password, salt, encryptedDashboard.iterations);
    ...
    function getFragmentPassword(fragment) {
    ...
    const fragmentCleared = !initialFragment || clearFragment();
    const fragmentPassword = fragmentCleared ? getFragmentPassword(initialFragment) : null;
    if (fragmentPassword) {
      void tryUnlock(fragmentPassword);
    }
  </script>
</body>
</html>`;
